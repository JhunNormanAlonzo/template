                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select form-select-sm" name="school_year_id" id="">
                                    @foreach($school_years as $school_year)
                                        <option @if($activated_school_year->id == $school_year->id) selected @endif value="{{$school_year->id}}">{{$school_year->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-4">
                                ...
                                <x-input-number name="amount" step="0.01" ></x-input-number>
